...
# config.py
mass_shift_annotation_url = None   # was a Google Sheet; currently set to None because the file is unavailable

unimod_file = os.path.join(data_dir, "external", "unimod_tables.xml") # changed this to a local path because the URL is unreachable by the package
